          ...
          <AnimatePresence>
            {open ? (
              <motion.div
                ...
                className="fixed inset-0 z-[100] bg-ink-900/40 backdrop-blur-[2px] lg:hidden"
            ...
            {open ? (
              <motion.aside
                ...
                aria-modal="true"
                aria-label="Menú"
                className="fixed inset-y-0 right-0 z-[101] flex w-[88%] max-w-sm flex-col bg-cream-50 shadow-[0_24px_80px_-12px_rgba(13,45,92,0.25)] lg:hidden"
              >

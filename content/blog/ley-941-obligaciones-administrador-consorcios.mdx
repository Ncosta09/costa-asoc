...
- **Los juicios en los que el consorcio sea parte**, con juzgado, expediente, carátula, objeto, estado y capital reclamado. Es el único dato de cobranza que el artículo 10 exige de forma expresa.
- Y una buena práctica que la ley no impone pero conviene pedir: **el estado de mora unidad por unidad**, porque de la cobranza depende el fondo operativo del edificio.
...
Y hay una obligación de rendición que no viene de la Ley 941 sino del Código, y que muchos consorcios no tienen en el radar: el **artículo 2067 del [Código Civil y Comercial](https://servicios.infoleg.gob.ar/infolegInternet/anexos/235000-239999/235975/texact.htm)** exige al administrador **rendir cuenta documentada dentro de los sesenta días del cierre del ejercicio financiero** fijado en el reglamento de propiedad horizontal. La liquidación mensual es la rendición corriente; esta otra es la del ejercicio completo, y es la que permite ver el año entero en perspectiva.
...
Los incumplimientos no quedan en el aire. Cualquier propietario o inquilino afectado (y las asociaciones de consumidores inscriptas en la Ciudad) puede denunciarlos ante la **Dirección General de Defensa y Protección al Consumidor** de CABA, que es el organismo de aplicación del RPA. Qué hay que presentar y cómo sigue el trámite lo detallamos en [cómo denunciar a un administrador de consorcio en CABA](/blog/como-denunciar-a-un-administrador-de-consorcio).

...
El punto no es que esta tabla sea ley, porque no lo es, sino que **su versión concreta tiene que estar en el acta de su edificio**. Cuando no está, cada factura "por trámites" abre una discusión sin árbitro.

...
Esta nota explica por qué el cobro es tan ágil, qué defensas admite y cuáles no, cuándo prescribe la deuda y qué conviene hacer antes de que el reclamo llegue a un juzgado. Es el complemento de nuestra guía sobre [cómo se calculan las expensas de un consorcio](/blog/expensas-consorcio-que-son-como-se-liquidan).

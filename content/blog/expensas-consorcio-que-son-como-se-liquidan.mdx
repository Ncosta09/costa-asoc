...
Si la liquidación es un número global sin respaldo, o si no se entiende de dónde sale cada peso, algo falta. La [Ley 941](/blog/ley-941-obligaciones-administrador-consorcios) exige justamente esa trazabilidad: rendición documentada, comprobantes disponibles y cuenta bancaria a nombre del consorcio. Cuando el reclamo se repite mes a mes y no hay respuesta, el consorcio puede evaluar [cambiar de administrador](/blog/como-cambiar-de-administrador-de-consorcio): la asamblea puede removerlo sin expresión de causa.

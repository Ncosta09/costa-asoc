...
## ¿Es lo mismo el consejo de administración que el consejo de propietarios?

Sí, es el mismo órgano con dos nombres, y conviene aclararlo porque en la mayoría de los edificios se usa el que el Código no usa.

El Código Civil y Comercial usa una sola denominación: **consejo de propietarios**. Así se titula el Capítulo 6 del régimen de propiedad horizontal, así lo nombra el artículo 2044 entre los tres órganos del consorcio y así lo llama el artículo 2056 inciso u) cuando le exige al reglamento fijar sus "facultades especiales del consejo de propietarios".

**"Consejo de administración" es el nombre heredado.** Aparece en los reglamentos redactados bajo la Ley 13.512, el régimen de propiedad horizontal que rigió desde 1948 y que quedó derogado por el artículo 3º de la Ley 26.994, la que aprobó el Código vigente. Como el reglamento de la mayoría de los edificios de CABA es anterior a 2015 y casi nunca se actualiza, el nombre viejo sobrevivió en las actas, en los carteles del hall y en la forma de hablar del consorcio. También se lo escucha como "comisión de administración" o "comité de administración".

Dos consecuencias prácticas:

- **El nombre no cambia las atribuciones.** Si el acta dice "consejo de administración", el órgano es igual de válido y lo que rige son el artículo 2064 más lo que agregue el reglamento. No hay que renombrar nada ni volver a designarlo.
- **Ojo con el falso amigo.** En una asociación civil o en una cooperativa, el consejo de administración sí es el órgano que administra. Acá es al revés: el último párrafo del artículo 2064 dice expresamente que el consejo **no sustituye al administrador ni puede cumplir sus obligaciones**. Mismo nombre, función opuesta.

Si el reglamento de su edificio usa la denominación vieja, lo que vale la pena revisar no es el título sino si ese capítulo le fijó facultades especiales, porque ahí puede haber atribuciones que el Código no trae.

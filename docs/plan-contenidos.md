...
| Obligaciones del edificio en CABA | `/blog/ley-257-caba-fachadas-y-balcones` | ✅ publicado |
...
> **Próximo a escribir: el ítem 16 (ascensores, 110/mes, CPC $1,35), después el 12 (fondo de reserva, 100/mes) y el 14 (seguros, 90/mes).** Orden fijado el 2026-09-09 con la medición de DataForSEO. El 10 (pilar de Obligaciones CABA) se publicó el 2026-09-23, el 8 el 2026-09-17 y el 9 el 2026-09-09. El 7 (30/mes) tiene un borrador sin citas verificadas en el log de la corrida del 31-08, sirve como spec cuando le toque. **Los ítems 19, 22, 23 y 24 se archivaron: volumen medido 0 a 10 en todas sus variantes.**
...
| 9 | ✅ | `funciones-del-consejo-de-propietarios` | consejo de propietarios | Asambleas | Publicada 2026-09-07 (fecha de su corrida; subida el 09-09). Público = nuestro comprador real. **Vol medido: 260/mes.** Ángulo: las 4 atribuciones del art. 2064 en cuadro + el límite expreso del último párrafo (no sustituye al administrador); el inciso b (control económico y financiero) traducido a un cruce mensual de 5 puntos apoyado en Ley 941 arts. 9º y 10; certificado de deuda aprobado por el consejo = título ejecutivo (art. 2048); fondo de reserva visto desde 2064 inc. c y 2067 inc. d; entrega de libros AL CONSEJO en 15 días hábiles (2067 inc. j) y vacancia con 30 días para convocar (2064 inc. d) cruzada con la inscripción obligatoria de la Ley 941 arts. 2º y 3º. Dato verificado: **la Ley 941 no menciona al consejo ni una vez.** Todas las citas leídas del texto oficial. **Editada el 2026-09-17:** se sumó el H2 "¿Es lo mismo el consejo de administración que el consejo de propietarios?", que es la formulación con la que se busca el 27% del cluster (110 de 410/mes) y que la nota no usaba en ningún encabezado |
| 8 | ✅ | `como-verificar-la-matricula-rpa-de-tu-administrador` | **registro publico de administradores de consorcios** | Administrador | Publicada 2026-09-17 (escrita en la corrida del 14-09, reescrita local con las citas verificadas). **Vol medido: 320/mes.** El slug quedó como estaba pero el H1, el title y todo el cuerpo se reenfocaron sobre el Registro, no sobre el verbo "verificar" (esa variante da 0). Ángulo: el RPA no es una lista binaria sino un legajo público que por el art. 7º incluye **las sanciones de los últimos dos años**, y el art. 20 obliga a que consten ahí hasta dos años después de impuestas. Suma el certificado de acreditación del art. 6º (vale 30 días, lista sanciones y hay que exigirlo en la asamblea que designa, con el art. 15 inc. e) como sanción por no presentarlo), los 120 hs de capacitación + 10 hs de revalidación anual del art. 4º, los impedimentos del art. 5º, la DDJJ anual del art. 12, la escala del art. 16 (300 a 20.000 unidades fijas) y el Capítulo VI de la Aplicación Oficial (arts. 23, 27 y 29). Dato diferencial: **el administrador voluntario gratuito también tiene que inscribirse** (arts. 2º y 3º) y para él no estar inscripto es la única infracción posible (art. 15 inc. a). Todas las citas leídas del texto de CEDOM |
| 10 | ✅ | `ley-257-caba-fachadas-y-balcones` | **conservacion de fachadas caba** | Obligaciones CABA | Publicada 2026-09-23 (escrita en la corrida del 21-09, reescrita local con las citas leídas del texto oficial). **Pilar del cluster. Vol medido: 240/mes** entre "conservacion de fachadas caba" 110 (CPC $1,62), "ley 257 caba" 90 ($1,48) y "ley de fachadas caba" 40 ($1,77). **Hallazgo que cambió el encuadre: la Ley 257 fue ABROGADA por el art. 119 de la Ley 6438 (BOCBA 6194, 17/08/2021)**; antes la había reescrito la Ley 6116 (BOCBA 5534, 10/01/2019). El régimen vive hoy en el **art. 5.1.2 del Código de la Edificación** (CEDOM, Título 5): definición amplia de fachada (frente, contrafrente y laterales al espacio público), lista no taxativa de elementos, certificación técnica "única e improrrogable" con periodicidad por antigüedad (15-25 años cada 15 · 25-35 cada 12 · 35-45 cada 10 · 45-55 cada 9 · 55-70 cada 5 · +70 cada 4), eximidos PB ≤4 m y vivienda 4-9 m retirada 3 m (salvo salientes), profesionales con título y matrícula (CPAU/CPIC/CPII según el trámite del GCBA, portal instalaciones.agcontrol.gob.ar, certificado con QR, gratuito por Ley Tarifaria). Multa: Ley 451 art. **2.2.14.1** (la Ley 6116 lo llamó 2.1.14 bis por error, según nota del texto ordenado del MPF): 1.000 a 5.500 UF y/o inhabilitación/clausura; genérica 2.2.14: 50 a 5.500; estética urbana 2.2.16: 1.400 a 6.800 + remoción. UF = medio litro de nafta premium (art. 19). Ángulo contable: fachada y estructura de balcones son partes necesariamente comunes (CCyC 2041 incs. d e i); informe y reparaciones = ordinarias (2048), obra grande = extraordinaria por asamblea; reparar no es mejora (no aplica 2051); la certificación es deber del administrador (2067 inc. c + Ley 941 art. 9º) y el consejo controla (2064 b y c). Todas las citas leídas del texto oficial |
| 11 | ✅ | `como-denunciar-a-un-administrador-de-consorcio` | **denunciar administrador de consorcio** | Administrador | Publicada 2026-09-24. **Keyword corregida con volumen medido:** "administrador no rinde cuentas" y todas sus variantes dan 0; "denunciar/denuncia administrador de consorcio" 260/mes y "listado de administradores de consorcio denunciados" **480/mes** (LOW, CPC $0,65). La PAA "¿Dónde denunciar al administrador de consorcio en CABA?" sale en dos SERP comerciales. Ángulo: la denuncia sanciona pero no recupera (dos carriles), aprobación tácita de la rendición a los 30 días (CCyC 862-863), trámite oficial completo y "no hay listado de denunciados, sí de sancionados" (Ley 941 arts. 6º, 7º y 20 + buscador con disposición). |

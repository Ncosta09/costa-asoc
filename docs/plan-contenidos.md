...
> **Próximo a escribir: el ítem 8 (registro público de administradores, 320/mes), después el 16 (ascensores, 110/mes, CPC alto) y el 7 (certificado de deuda, 30/mes).** El 9 se publicó el 2026-09-07 (primera corrida con el Paso 0 de fetch + reset: eligió bien). El 7 tiene un borrador sin citas verificadas en el log de la corrida del 31-08, sirve como spec cuando le toque.
